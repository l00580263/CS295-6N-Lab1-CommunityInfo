...
namespace CommunityInformation.Models
{
    public class FakeRepo : IRepository
    {
        ...
        public FakeRepo()
        {
            ...
            Users.ToList().AddRange(new User[] { user1, user2, user3 });
            Message message1 = new Message() { Subject = "This site sucks", Text = "Not kidding, RIP.", Recipient = user2, Sender = user1 };
            Message message2 = new Message() { Subject = "RE: This site sucks", Text = "swag yeah", Recipient = user1, Sender = user2 };
            ...
            Messages.ToList().AddRange(new Message[] { message1, message2, message3, message4 });
            // log in as Bobby
            LoggedIn = user2;
        }
